    ...
    <div class="flex flex-col gap-2 border border-base-300 rounded-2xl p-2 bg-base-100 text-base-content shadow-lg">
      <div class="flex items-center gap-2">
        <svg
          ...
          class="icon icon-tabler icons-tabler-outline icon-tabler-eye-cog shrink-0 text-secondary"
        >
        ...
        <span class="font-bold text-sm text-base-content">{gettext("Presentation Settings")}</span>
      </div>
